        ...
        <div class="wrapper">
            ...
            <aside id="left-sidebar-nav">
                <ul id="slide-out" class="side-nav fixed leftside-navigation">
                    ...
                    <li class="bold"><a href="dashbord.php" class="waves-effect waves-cyan"><i
                                class="mdi-editor-border-color"></i> Dashbord</a>
                    </li>
                    ...
                    <li class="bold active"><a href="users.php" class="waves-effect waves-cyan"><i
