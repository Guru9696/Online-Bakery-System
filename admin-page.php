        ...
        <div class="wrapper">
            ...
            <aside id="left-sidebar-nav">
                <ul id="slide-out" class="side-nav fixed leftside-navigation">
                    ...
                    <li class=""><a href="dashbord.php" class="waves-effect waves-cyan"><i
            ...
            <section id="content">
                ...
                <div class="container">
                           ...
                           <div class ="col s12 m4 l3">
                            ...
                            <div>
                                ...
                                <table >
                                    ...
                                    <tbody>
                                        <?php
                                            // $set_empty_stock = "UPDATE items SET stock = 0 WHERE deleted = 1";
                                            // $con->query($set_empty_stock);
                                            $set_availability = "UPDATE items SET deleted = 0 WHERE stock > 0";
                                            ...
                                            while($row = mysqli_fetch_array($result))
                                            {
                                                ...
                                                echo '<img src="'.$row["photo"].'" alt="'.$row['id'].'_photo" width="100px" data-error=".errorTxt'.$row["id"].'"><div class="errorTxt'.$row["id"].'"></div></td>';
                                                ...
                                                echo '<td><div class="input-field col s12 "><label for="'.$row["id"].'_stock">Stock</label>';
                                                echo '<input value="'.$row["stock"].'" id="'.$row["id"].'_stock" name="'.$row['id'].'_stock" type="text" data-error=".errorTxt'.$row["id"].'"><div class="errorTxt'.$row["id"].'"></div></td>';                   
                                                echo '<td>';
                                                if($row['deleted'] == 0){
                                                    $text1 = 'selected';
                                                    $text2 = '';
                    ...
                    <!-- <form class="formValidate" id="formValidate1" method="post" action="routers/check-then-add.php" -->
                        ...
                        <div class="row">
                            ...
                            <div>
                                <table>
                                    ...
                                    <tbody>
                                        <?php
                                            echo '<tr><td><div class="input-field col s12"><label for="name">Name</label></div>';
                                            echo '<input id="name" name="name" type="text" data-error=".errorTxt01"><div class="errorTxt01"></div></td>';
                                            
                                            echo '<td><div class="input-field col s12 "></div>';
                                            echo '<img id="product_image" name="product_image" src="" alt="Product Image" width="100px" height="80px"></td>';
                                            
                                            echo '<td><div class="input-field col s12 "></div>';
                                            echo '<input id="photo" name="fileToUpload" type="file" onblur="checkPhoto()"></td>';

                                            echo '<td><div class="input-field col s12 "><label for="price" class="">Price</label></div>';
                            ...
                            <div class="input-field col s12">
                                <button class="btn cyan waves-effect waves-light right" type="submit" name="add_action">Add
                                    <i class="mdi-content-send right"></i>
                                </button>
                            </div>
                        </div>
