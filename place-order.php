        ...
        <a href="#" class="secondary-content"><i class="mdi-action-grade"></i></a>';
                    ...
                    foreach ($_POST as $key => $value) {
                      ...
                      if (is_numeric($key)) {
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                          if(!$row) {
                            echo "<h2> console.log('Please select at least one product to place order...!!!')</h2>";
                          }else {
                            $price = $row['price'];
                            $item_name = $row['name'];
                            $item_id = $row['id'];
                        ...
                        echo '<li class="collection-item">
                                <div class="row">
                                  ...
                                  <div class="col s3"><span>Rs. ' . $price . '</span></div>
                                </div>
                              </li>';
                        $total = $total + $price;
                      }
                    ...
                    echo '<li class="collection-item">
                            <div class="row">
                              ...
                              <div class="col s3"><span><strong>Rs. ' . $total . '</strong></span></div>
                            </div>
                          </li>';
