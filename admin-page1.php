        ...
        <div class="wrapper">
                    ...
                    <form class="formValidate" id="formValidate" method="post" action="routers/menu-router.php" novalidate="novalidate">
                            <?php
                                  ...
                                  while ($row = mysqli_fetch_array($result)) {
                                    echo '<div class="product-container" id="product-container">
            ...
            <!-- <div class="container">
                <form class="formValidate" id="formValidate1" method="post" action="routers/add-item.php"
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="photo">Product Image</th>
                                    </tr>
                                </thead>
                  ...
                  echo '<td><div class="input-field col s12 "><label for="photo">Product Image URL</label>';
                  echo '<input id="photo" name="photo" type="text" required></td>';
                  //SET ERROR IN JQuery
                  echo '<td></tr>';
                  ?>
                                </tbody>
